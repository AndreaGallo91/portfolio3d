  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-fade-in">
      <div className="glass rounded-xl px-6 py-4 text-center max-w-md">
        <p className="text-space-light/90 text-sm mb-2">
          {isMobile
        ...
        {!isMobile && (
          <div className="flex items-center justify-center gap-4 text-xs text-space-light/60">
            <div className="flex items-center gap-1">
              <kbd className="px-2 py-1 bg-space-gray rounded text-space-cyan">
                Scroll
              </kbd>
              <span>Zoom</span>
            </div>
        ...
        <p className="text-space-purple text-xs mt-3 animate-pulse">
